/**
 * @name TipoSeguimientoController
 * @type Class
 * @description Controlador encargado de la validación de usuarios en el sistema
 * @author enosReyes
 */

const { TipoSeguimientoService } = require('../../services/tipoSeguimiento.service')
const { Process } = require('../../base/process')
const Message = require('../../messages/message')
const Log4js = require('../../base/log4js')()
let _service = null
const table = 'mTipoSeguimiento'

class TipoSeguimientoController {
	constructor() {
		_service = new TipoSeguimientoService()
	}
...
module.exports.TipoSeguimientoController = TipoSeguimientoController
